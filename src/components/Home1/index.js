                       ...
                       <div class="hero-image-slide">
                                ...
                                <div style={{flexDirection: "column"}} class="col-md-10 col-sm-10 col-xs-10 searching-form">
                                    <div>
                                        ...
                                        <button class="custom-btn btn-3"><span style={{fontSize:18}}>Add a Business</span></button>
                                        </a>
                                    </div>
                                    <div style={{marginTop:15}}>
                                        <a href={`/register-job/${auth?.currentUser?.uid}`}>
                                        <button class="custom-btn btn-3"><span style={{fontSize:18}}>Add a Job</span></button>
                                        </a>
                                    </div>
                                </div>
                            </div>
  ...
  <CSSTransition
          ...
          <div style={{height: 180}} className="menu">
            ...
            <DropdownItem style={{marginTop: 15}} leftIcon={<BusinessCenterSharpIcon />}>
                <a href="/categories">
                  <p style={{marginTop:0}}>Categories(Businesses)</p>
                  </a>
                  </DropdownItem>
            <DropdownItem style={{marginTop: 15}} leftIcon={<BusinessCenterSharpIcon />}>
                <a href="/list-businesses">
                  <p style={{marginTop:0}}>Locations(Businesses)</p>
                  </a>
                  </DropdownItem>
          </div>
        </CSSTransition>
